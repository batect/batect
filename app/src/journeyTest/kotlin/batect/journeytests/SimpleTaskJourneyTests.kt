...
object SimpleTaskJourneyTests : Spek({
    mapOf(
        ...
        "simple-task-entrypoint-on-container" to "a simple task with an entrypoint specified on the container in the configuration file",
        "simple-task-entrypoint-on-task" to "a simple task with an entrypoint specified on the task in the configuration file",
