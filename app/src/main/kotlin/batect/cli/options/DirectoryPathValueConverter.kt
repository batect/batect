...
class DirectoryPathValueConverter(private val resolver: PathResolver, private val mustExist: Boolean = false) : PathValueConverter {
    override fun convert(value: String): ValueConversionResult<Path> = when (val result = resolver.resolve(value)) {
