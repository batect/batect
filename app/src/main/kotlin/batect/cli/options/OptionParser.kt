...
interface OptionParserContainer {
    ...
    fun setMultiValueOption(group: OptionGroup, longName: String, description: String, shortName: Char? = null) = SetMultiValueOption(group, longName, description, shortName)
}
