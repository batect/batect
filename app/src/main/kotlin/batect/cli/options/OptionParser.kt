...
interface OptionParserContainer {
    ...
    fun mapOption(longName: String, description: String, valueFormatForHelp: String, shortName: Char? = null) = MapOption(longName, description, shortName, valueFormatForHelp)
}
