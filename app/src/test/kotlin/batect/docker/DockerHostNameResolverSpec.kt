...
private fun createDockerVersionInfoWithServerVersion(version: Version) = DockerVersionInfo(
    DockerClientVersionInfo(Version(1, 0, 0), "", ""),
    DockerServerVersionInfo(version, "", "", "")
)
