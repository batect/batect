    ...
    describe("a Docker container creation request factory") {
        ...
        given("the console's type is not provided") {
            ...
            given("propagating proxy environment variables is disabled") {
                ...
                val factory = DockerContainerCreationRequestFactory(proxyEnvironmentVariablesProvider, hostEnvironmentVariables)
                ...
                given("and the reference is to an environment variable that does not exist on the host") {
                    ...
                    on("creating the request") {
                        ...
                        it("throws an appropriate exception") {
                            assertThat({ factory.create(container, image, network, config, emptySet(), propagateProxyEnvironmentVariables, null, terminalType, allContainersInNetwork) },
