...
object DockerHostNameResolverSpec : Spek({
    describe("a Docker host name resolver") {
        ...
        given("the local system is running macOS") {
            ...
            data class Scenario(val dockerVersion: String, val expectedHostName: String, val description: String)

            listOf(
                Scenario("17.6.0", "docker.for.mac.localhost", "the Docker version being 17.06"),
                Scenario("17.6.0-mac1", "docker.for.mac.localhost", "the Docker version being above 17.06 but less than 17.12"),
        ...
        given("the local system is running Windows") {
            ...
            listOf(
                Scenario("17.6.0", "docker.for.win.localhost", "the Docker version being 17.06"),
                Scenario("17.6.0-windows1", "docker.for.win.localhost", "the Docker version being above 17.06 but less than 17.12"),
...
private fun createDockerVersionInfoWithServerVersion(version: String) = DaemonVersionInformation(version, "", "", "", "", "", false)
