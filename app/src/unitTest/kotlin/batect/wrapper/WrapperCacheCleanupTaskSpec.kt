...
object WrapperCacheCleanupTaskSpec : Spek({
    describe("a wrapper cache cleanup task") {
        ...
        val cleanupTask by createForEachTest { WrapperCacheCleanupTask(wrapperCache, versionInfo, logger, threadRunner, timeSource) }
        ...
        // Two versions available, one throws an exception on deletion -> other one still removed, logs warning
    }
})
