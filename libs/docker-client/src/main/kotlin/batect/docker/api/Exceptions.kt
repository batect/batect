...
class NetworkInspectionFailedException(val networkId: String, val outputFromDocker: String) : DockerException("Getting details of network '$networkId' failed: $outputFromDocker")
class NetworkDoesNotExistException(val networkId: String) : DockerException("The network '$networkId' does not exist.")
