                ...
                assertThat(
                    ...
                    equalTo(
                        listOf(
                            ...
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.Downloading, 42704L + 423, 4178135L + 1772))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.Downloading, 281854L + 42704 + 423, 27092161L + 4178135 + 1772))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.Downloading, 281854L + 42704 + 1772, 27092161L + 4178135 + 1772))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.Downloading, 5863899L + 42704 + 1772, 27092161L + 4178135 + 1772))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.Downloading, 5863899L + 4164061 + 1772, 27092161L + 4178135 + 1772))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.Downloading, 5863899L + 4178135 + 1772, 27092161L + 4178135 + 1772))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.Downloading, 6978011L + 4178135 + 1772, 27092161L + 4178135 + 1772))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.VerifyingChecksum, 0L + 4178135 + 1772, 27092161L + 4178135 + 1772))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.DownloadComplete, 27092161L + 4178135 + 1772, 27092161L + 4178135 + 1772))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.Extracting, 294912L + 0 + 0, 27092161L + 4178135 + 1772))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.PullComplete, 27092161L + 0 + 0, 27092161L + 4178135 + 1772))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.Downloading, 27092161L + 4178135 + 1772 + 503039, 27092161L + 4178135 + 1772 + 1419223))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.VerifyingChecksum, 27092161L + 4178135 + 1772 + 0, 27092161L + 4178135 + 1772 + 1419223))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.PullComplete, 27092161L + 0 + 0 + 0, 27092161L + 4178135 + 1772 + 1419223))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.Extracting, 27092161L + 65536 + 0 + 0, 27092161L + 4178135 + 1772 + 1419223))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.Extracting, 27092161L + 4178134 + 0 + 0, 27092161L + 4178135 + 1772 + 1419223))),
                            BuildProgress(setOf(ActiveImageBuildStep.Downloading(0, "step 1 of 2: FROM postgres:13.0", DownloadOperation.PullComplete, 27092161L + 4178135 + 0 + 0, 27092161L + 4178135 + 1772 + 1419223))),
