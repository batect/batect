...
object VersionInfoCommandSpec : Spek({
    describe("a 'version info' command") {
        describe("command line interface") {
            ...
            describe("when given no parameters") {
                ...
                it("returns a command instance ready for use") {
                    assertThat((result as Succeeded).command, equalTo<Command>(VersionInfoCommand(versionInfo, outputStream, systemInfo)))
                }
            }
        }
        ...
        on("when invoked") {
            ...
            val command = VersionInfoCommand(versionInfo, PrintStream(outputStream), systemInfo)
